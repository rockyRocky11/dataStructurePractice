...
public class FibnonacciSeq {
    public static void main(String[] args){
        ...
        storeArray3[1]=1;
        storeArray3[2]=1;
        System.out.println(fiboBottomUp(input1, storeArray2));//5
        System.out.println(fiboBottomUp(input2, storeArray3));
    }
    ...
    public static int fiboBottomUp(int input, int[] storeArray){
        if(storeArray[input]>0){
            return storeArray[input];
        }
