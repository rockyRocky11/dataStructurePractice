...
public class LongestPalindromeSubseq3 {
    public static void main(String[] args) {
        ...
        System.out.println(longestPalindromeSubseqTrueDp("bbbab"));
    ...
    public static int longestPalindromeSubseqTrueDp(String s) {
        int n = s.length();
        int[][] dp = new int[n][n];
        ...
        // Expand window from smaller substrings to larger
