...
public class TowerHanoi {
    public static void main(String[] args) {
        ...
        System.out.println("-----------------------------");
        towerOfHanoi(tower1.size(), tower1, "tower1", tower2,"tower2", tower3, "tower3");


        System.out.println(towerOfHanoi(3, 1, 3, 2));
    }

    public static void towerOfHanoi(int n, Stack<Integer> from, String fromName, Stack<Integer> helper, String helperName, Stack<Integer> to, String toName) {
        ...
        towerOfHanoi(n-1, from, fromName, to, toName, helper, helperName);
        if(!from.isEmpty()){
            to.push(from.pop());
            System.out.println("-----------------------------");
            printTower(from,fromName);
        ...
        towerOfHanoi(n-1, helper, helperName, from, fromName, to, toName);
